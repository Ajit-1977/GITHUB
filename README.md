...
2. I've clicked "Add people" and entered pratik's GitHub username 👩‍💻
3. I've sent an invitation with a message: "In collaboration with pratik for the Git assignment" 📨
4. I've waited for pratik to accept the invitation ✅
...
6. **🔀 Create Pull Request**
   ...
   - I've requested pratik to review the PR 👀
...
4. **👀 Code Review Process**
   - I've requested pratik to review my PRs 🔍
   - I've added a comment: "In collaboration with pratik" 💬
   - I've addressed feedback from pratik 📝
...
### *In collaboration with pratik* 👩‍💻

Throughout this project, I've worked closely with pratik to implement the Git workflow and features. pratik has:
